...
class ViewController: UITableViewController {
            ...
            if isOriginal(word: lowerAnswer) {
                if isReal(word: lowerAnswer) {
                   ...
                   errorTitle = "Word not recognised"
                    errorMessage = "Are you just making stuff up?"
                }
            } else {
    ...
    func isReal(word: String) -> Bool {
        ...
        let misspeelledRange = checker.rangeOfMisspelledWord(in: word, range: range, startingAt: 0, wrap: false, language: "en")
        
        return misspeelledRange.location == NSNotFound
    }
